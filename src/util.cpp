...
int nAnonymizeTokugawaAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Tokugawa
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Tokugawa
    // Mac: ~/Library/Application Support/Tokugawa
    // Unix: ~/.Tokugawa
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tokugawa";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Tokugawa.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Tokugawad.pid"));
