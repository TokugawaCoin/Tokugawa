...
private slots:
    ...
    QString BuyTOK(QString OrderType, double Quantity, double Rate);
    QString SellTOK(QString OrderType, double Quantity, double Rate);
